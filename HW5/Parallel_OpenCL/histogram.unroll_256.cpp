...
Image *readbmp(const char *filename)
{
    ...
    uint32_t residue   = ret->size%256;
    for (int k = 0; k < residue; ++k){
        bmp.read((char *)&ret->data[k], depth / 8);
    }

    for (int i = residue; i < ret->size; i+=256)
    {
        ...
        bmp.read((char *)&ret->data[i+64], depth / 8);        
        bmp.read((char *)&ret->data[i+65], depth / 8);        
        bmp.read((char *)&ret->data[i+66], depth / 8);        
        bmp.read((char *)&ret->data[i+67], depth / 8);        
        bmp.read((char *)&ret->data[i+68], depth / 8);        
        bmp.read((char *)&ret->data[i+69], depth / 8);        
        bmp.read((char *)&ret->data[i+70], depth / 8);        
        bmp.read((char *)&ret->data[i+71], depth / 8);        
        bmp.read((char *)&ret->data[i+72], depth / 8);        
        bmp.read((char *)&ret->data[i+73], depth / 8);        
        bmp.read((char *)&ret->data[i+74], depth / 8);        
        bmp.read((char *)&ret->data[i+75], depth / 8);        
        bmp.read((char *)&ret->data[i+76], depth / 8);        
        bmp.read((char *)&ret->data[i+77], depth / 8);        
        bmp.read((char *)&ret->data[i+78], depth / 8);        
        bmp.read((char *)&ret->data[i+79], depth / 8);        
        bmp.read((char *)&ret->data[i+80], depth / 8);        
        bmp.read((char *)&ret->data[i+81], depth / 8);        
        bmp.read((char *)&ret->data[i+82], depth / 8);        
        bmp.read((char *)&ret->data[i+83], depth / 8);        
        bmp.read((char *)&ret->data[i+84], depth / 8);        
        bmp.read((char *)&ret->data[i+85], depth / 8);        
        bmp.read((char *)&ret->data[i+86], depth / 8);        
        bmp.read((char *)&ret->data[i+87], depth / 8);        
        bmp.read((char *)&ret->data[i+88], depth / 8);        
        bmp.read((char *)&ret->data[i+89], depth / 8);        
        bmp.read((char *)&ret->data[i+90], depth / 8);        
        bmp.read((char *)&ret->data[i+91], depth / 8);        
        bmp.read((char *)&ret->data[i+92], depth / 8);        
        bmp.read((char *)&ret->data[i+93], depth / 8);        
        bmp.read((char *)&ret->data[i+94], depth / 8);        
        bmp.read((char *)&ret->data[i+95], depth / 8);        
        bmp.read((char *)&ret->data[i+96], depth / 8);        
        bmp.read((char *)&ret->data[i+97], depth / 8);        
        bmp.read((char *)&ret->data[i+98], depth / 8);        
        bmp.read((char *)&ret->data[i+99], depth / 8);        
        bmp.read((char *)&ret->data[i+100], depth / 8);        
        bmp.read((char *)&ret->data[i+101], depth / 8);        
        bmp.read((char *)&ret->data[i+102], depth / 8);        
        bmp.read((char *)&ret->data[i+103], depth / 8);        
        bmp.read((char *)&ret->data[i+104], depth / 8);        
        bmp.read((char *)&ret->data[i+105], depth / 8);        
        bmp.read((char *)&ret->data[i+106], depth / 8);        
        bmp.read((char *)&ret->data[i+107], depth / 8);        
        bmp.read((char *)&ret->data[i+108], depth / 8);        
        bmp.read((char *)&ret->data[i+109], depth / 8);        
        bmp.read((char *)&ret->data[i+110], depth / 8);        
        bmp.read((char *)&ret->data[i+111], depth / 8);        
        bmp.read((char *)&ret->data[i+112], depth / 8);        
        bmp.read((char *)&ret->data[i+113], depth / 8);        
        bmp.read((char *)&ret->data[i+114], depth / 8);        
        bmp.read((char *)&ret->data[i+115], depth / 8);        
        bmp.read((char *)&ret->data[i+116], depth / 8);        
        bmp.read((char *)&ret->data[i+117], depth / 8);        
        bmp.read((char *)&ret->data[i+118], depth / 8);        
        bmp.read((char *)&ret->data[i+119], depth / 8);        
        bmp.read((char *)&ret->data[i+120], depth / 8);        
        bmp.read((char *)&ret->data[i+121], depth / 8);        
        bmp.read((char *)&ret->data[i+122], depth / 8);        
        bmp.read((char *)&ret->data[i+123], depth / 8);        
        bmp.read((char *)&ret->data[i+124], depth / 8);        
        bmp.read((char *)&ret->data[i+125], depth / 8);        
        bmp.read((char *)&ret->data[i+126], depth / 8);        
        bmp.read((char *)&ret->data[i+127], depth / 8);
        bmp.read((char *)&ret->data[i+128], depth / 8);
        bmp.read((char *)&ret->data[i+129], depth / 8);
        bmp.read((char *)&ret->data[i+130], depth / 8);
        bmp.read((char *)&ret->data[i+131], depth / 8);
        bmp.read((char *)&ret->data[i+132], depth / 8);
        bmp.read((char *)&ret->data[i+133], depth / 8);
        bmp.read((char *)&ret->data[i+134], depth / 8);
        bmp.read((char *)&ret->data[i+135], depth / 8);
        bmp.read((char *)&ret->data[i+136], depth / 8);
        bmp.read((char *)&ret->data[i+137], depth / 8);
        bmp.read((char *)&ret->data[i+138], depth / 8);
        bmp.read((char *)&ret->data[i+139], depth / 8);
        bmp.read((char *)&ret->data[i+140], depth / 8);
        bmp.read((char *)&ret->data[i+141], depth / 8);
        bmp.read((char *)&ret->data[i+142], depth / 8);
        bmp.read((char *)&ret->data[i+143], depth / 8);
        bmp.read((char *)&ret->data[i+144], depth / 8);
        bmp.read((char *)&ret->data[i+145], depth / 8);
        bmp.read((char *)&ret->data[i+146], depth / 8);
        bmp.read((char *)&ret->data[i+147], depth / 8);
        bmp.read((char *)&ret->data[i+148], depth / 8);
        bmp.read((char *)&ret->data[i+149], depth / 8);
        bmp.read((char *)&ret->data[i+150], depth / 8);
        bmp.read((char *)&ret->data[i+151], depth / 8);
        bmp.read((char *)&ret->data[i+152], depth / 8);
        bmp.read((char *)&ret->data[i+153], depth / 8);
        bmp.read((char *)&ret->data[i+154], depth / 8);
        bmp.read((char *)&ret->data[i+155], depth / 8);
        bmp.read((char *)&ret->data[i+156], depth / 8);
        bmp.read((char *)&ret->data[i+157], depth / 8);
        bmp.read((char *)&ret->data[i+158], depth / 8);
        bmp.read((char *)&ret->data[i+159], depth / 8);
        bmp.read((char *)&ret->data[i+160], depth / 8);
        bmp.read((char *)&ret->data[i+161], depth / 8);
        bmp.read((char *)&ret->data[i+162], depth / 8);
        bmp.read((char *)&ret->data[i+163], depth / 8);
        bmp.read((char *)&ret->data[i+164], depth / 8);
        bmp.read((char *)&ret->data[i+165], depth / 8);
        bmp.read((char *)&ret->data[i+166], depth / 8);
        bmp.read((char *)&ret->data[i+167], depth / 8);
        bmp.read((char *)&ret->data[i+168], depth / 8);
        bmp.read((char *)&ret->data[i+169], depth / 8);
        bmp.read((char *)&ret->data[i+170], depth / 8);
        bmp.read((char *)&ret->data[i+171], depth / 8);
        bmp.read((char *)&ret->data[i+172], depth / 8);
        bmp.read((char *)&ret->data[i+173], depth / 8);
        bmp.read((char *)&ret->data[i+174], depth / 8);
        bmp.read((char *)&ret->data[i+175], depth / 8);
        bmp.read((char *)&ret->data[i+176], depth / 8);
        bmp.read((char *)&ret->data[i+177], depth / 8);
        bmp.read((char *)&ret->data[i+178], depth / 8);
        bmp.read((char *)&ret->data[i+179], depth / 8);
        bmp.read((char *)&ret->data[i+180], depth / 8);
        bmp.read((char *)&ret->data[i+181], depth / 8);
        bmp.read((char *)&ret->data[i+182], depth / 8);
        bmp.read((char *)&ret->data[i+183], depth / 8);
        bmp.read((char *)&ret->data[i+184], depth / 8);
        bmp.read((char *)&ret->data[i+185], depth / 8);
        bmp.read((char *)&ret->data[i+186], depth / 8);
        bmp.read((char *)&ret->data[i+187], depth / 8);
        bmp.read((char *)&ret->data[i+188], depth / 8);
        bmp.read((char *)&ret->data[i+189], depth / 8);
        bmp.read((char *)&ret->data[i+190], depth / 8);
        bmp.read((char *)&ret->data[i+191], depth / 8);
        bmp.read((char *)&ret->data[i+192], depth / 8);
        bmp.read((char *)&ret->data[i+193], depth / 8);
        bmp.read((char *)&ret->data[i+194], depth / 8);
        bmp.read((char *)&ret->data[i+195], depth / 8);
        bmp.read((char *)&ret->data[i+196], depth / 8);
        bmp.read((char *)&ret->data[i+197], depth / 8);
        bmp.read((char *)&ret->data[i+198], depth / 8);
        bmp.read((char *)&ret->data[i+199], depth / 8);
        bmp.read((char *)&ret->data[i+200], depth / 8);
        bmp.read((char *)&ret->data[i+201], depth / 8);
        bmp.read((char *)&ret->data[i+202], depth / 8);
        bmp.read((char *)&ret->data[i+203], depth / 8);
        bmp.read((char *)&ret->data[i+204], depth / 8);
        bmp.read((char *)&ret->data[i+205], depth / 8);
        bmp.read((char *)&ret->data[i+206], depth / 8);
        bmp.read((char *)&ret->data[i+207], depth / 8);
        bmp.read((char *)&ret->data[i+208], depth / 8);
        bmp.read((char *)&ret->data[i+209], depth / 8);
        bmp.read((char *)&ret->data[i+210], depth / 8);
        bmp.read((char *)&ret->data[i+211], depth / 8);
        bmp.read((char *)&ret->data[i+212], depth / 8);
        bmp.read((char *)&ret->data[i+213], depth / 8);
        bmp.read((char *)&ret->data[i+214], depth / 8);
        bmp.read((char *)&ret->data[i+215], depth / 8);
        bmp.read((char *)&ret->data[i+216], depth / 8);
        bmp.read((char *)&ret->data[i+217], depth / 8);
        bmp.read((char *)&ret->data[i+218], depth / 8);
        bmp.read((char *)&ret->data[i+219], depth / 8);
        bmp.read((char *)&ret->data[i+220], depth / 8);
        bmp.read((char *)&ret->data[i+221], depth / 8);
        bmp.read((char *)&ret->data[i+222], depth / 8);
        bmp.read((char *)&ret->data[i+223], depth / 8);
        bmp.read((char *)&ret->data[i+224], depth / 8);
        bmp.read((char *)&ret->data[i+225], depth / 8);
        bmp.read((char *)&ret->data[i+226], depth / 8);
        bmp.read((char *)&ret->data[i+227], depth / 8);
        bmp.read((char *)&ret->data[i+228], depth / 8);
        bmp.read((char *)&ret->data[i+229], depth / 8);
        bmp.read((char *)&ret->data[i+230], depth / 8);
        bmp.read((char *)&ret->data[i+231], depth / 8);
        bmp.read((char *)&ret->data[i+232], depth / 8);
        bmp.read((char *)&ret->data[i+233], depth / 8);
        bmp.read((char *)&ret->data[i+234], depth / 8);
        bmp.read((char *)&ret->data[i+235], depth / 8);
        bmp.read((char *)&ret->data[i+236], depth / 8);
        bmp.read((char *)&ret->data[i+237], depth / 8);
        bmp.read((char *)&ret->data[i+238], depth / 8);
        bmp.read((char *)&ret->data[i+239], depth / 8);
        bmp.read((char *)&ret->data[i+240], depth / 8);
        bmp.read((char *)&ret->data[i+241], depth / 8);
        bmp.read((char *)&ret->data[i+242], depth / 8);
        bmp.read((char *)&ret->data[i+243], depth / 8);
        bmp.read((char *)&ret->data[i+244], depth / 8);
        bmp.read((char *)&ret->data[i+245], depth / 8);
        bmp.read((char *)&ret->data[i+246], depth / 8);
        bmp.read((char *)&ret->data[i+247], depth / 8);
        bmp.read((char *)&ret->data[i+248], depth / 8);
        bmp.read((char *)&ret->data[i+249], depth / 8);
        bmp.read((char *)&ret->data[i+250], depth / 8);
        bmp.read((char *)&ret->data[i+251], depth / 8);
        bmp.read((char *)&ret->data[i+252], depth / 8);
        bmp.read((char *)&ret->data[i+253], depth / 8);
        bmp.read((char *)&ret->data[i+254], depth / 8);
        bmp.read((char *)&ret->data[i+255], depth / 8);
    }
    return ret;
}
