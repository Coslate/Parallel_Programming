...
static double a[NZ][DOUBLE_PAD_SIZE];
...
static void makea(int n,
                  ...
                  int iv[]);
static void sparse(double a[][DOUBLE_PAD_SIZE],
                   int colidx[],
                   int rowstr[],
                   int n,
                   int nz,
